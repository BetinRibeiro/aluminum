...
db.define_table('usuario_empresa',
                Field('auth_user','reference auth_user', writable=True, readable=True, label='Usuario'),
...
db.define_table('projeto',
                ...
                Field('data_final', 'date', writable=True, readable=True, default=request.now, requires = IS_DATE(format=('%d-%m-%Y'))),
...
db.define_table('sub_venda',
                Field('projeto','reference projeto', label='Projeto', writable=True, readable=False),
...
db.define_table('despesa',
                Field('classe_despesa','reference classe_despesa', label='Classe', writable=True, readable=True),
