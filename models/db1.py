...
db.define_table('cheque',
                ...
                Field('projeto','reference projeto', writable=False, readable=False , label='Projeto'),
...
db.define_table('pagamento',
                ...
                Field('data_recebimento', 'date', label="Data Recebimento",notnull=True, default=request.now, requires = IS_DATE(format=('%d-%m-%Y'))),
                Field('quant_logins', 'string', label='Quant. Logins',requires = IS_UPPER()),
                Field('descricao', 'string', label='Descrição',requires = IS_UPPER()),
                Field('valor', 'double', writable=True, readable=True , notnull=True, default=0),
...
db.define_table('km',
                ...
                Field('km', 'integer', writable=True, readable=True , notnull=True, default=0),
                Field('condutor', 'string', label='Condutor',requires = IS_UPPER()),
                Field('descricao', 'string', label='Descrição',requires = IS_UPPER()),
                Field('valor_conbustivel', 'double', writable=True, readable=True , notnull=True, default=0),
                format='%(descricao)s')
...
db.define_table('boleto_atrasado',
                Field('projeto','reference projeto', label='Projeto'),
                Field('vendedor','reference vendedor', label='Vendedor'),
                Field('id_cliente','string', label='Cliente'),
                Field('id_asaas', 'string', label='Id asaas', unique=True),
                Field('description', 'string', label='Descrição'),
                Field('status', 'string', label='status'),
                Field('due_date', 'date', label="Data Recebimento", default=request.now, requires = IS_DATE(format=('%d-%m-%Y'))),
                ...
                Field('value_receber', 'double',label='Valor', notnull=True, default=0),
                Field('observacao', 'text', label='Observação', writable=True, readable=True,requires = IS_UPPER()),
                Field('ligou', 'boolean', writable=True, readable=True, default=False),
                Field('atendeu', 'boolean', writable=True, readable=True, default=False),
                Field('cobrou', 'boolean', writable=True, readable=True, default=False),
                )
