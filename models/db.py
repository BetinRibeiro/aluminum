...
db.define_table('funcionario_empresa',
                ...
                Field('equipe', 'string', label='Ultima Equipe',requires = IS_UPPER()),
                ...
                Field('logradouro', 'string', label='Logradouro',requires = IS_UPPER()),
...
db.define_table('classe_despesa_cobranca',
                ...
                Field('tipo', 'string', label='Tipo', writable=False, readable=False,default="Despesa_Cobranca"),
                Field('descricao', 'string', label='Descrição',requires = IS_UPPER()),
